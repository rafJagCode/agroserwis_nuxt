  ...
  <div class="contact-header">
    <div class="contact-header__text pa-2 pa-sm-12">
      ...
      <div class="contact-header__description">
        Szukasz pomocy? Masz pytania odnośnie produktu? Odezwij się do nas, z
        chęcią pomożemy.
      </div>
    </div>
    <div class="contact-header__image-container">
      <img
        class="contact-header__image"
        :src="`/static/contatct/images/contact_bg.jpg`"
      />
    </div>
  </div>
</template>
...
.contact-header__image-container::before {
  position: absolute;
  content: '';
  width: 400px;
  height: 100%;
